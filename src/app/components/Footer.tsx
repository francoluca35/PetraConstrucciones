...
export function Footer() {
  return (
    <footer id="page-footer" className="bg-[var(--mavic-navy)] text-white">
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-gray-300">
                ...
                <span className="text-sm">+54 1-3119-9872</span>
              </li>
              <li className="flex items-center text-gray-300">
              ...
              <li className="flex items-start text-gray-300">
                ...
                <span className="text-sm">Calle Principal 123, Merida, Mexico</span>
              </li>
            </ul>
          </motion.div>
...
<p className="text-sm text-gray-500">
  ...
  <span className="font-semibold text-[var(--petra-navy)]">
