    ...
    <div className="min-h-screen bg-white">
      ...
      <AnimatePresence>
        {lightboxOpen && (
          ...
          >
            {/* Backdrop: clic en cualquier parte cierra */}
            <button
              type="button"
            ...
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.95 }}
              className="relative max-w-7xl max-h-[90vh] w-full z-10 pointer-events-none"
            >
              ...
              {images.length > 1 && (
                <>
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); goToSlide(currentIndex - 1); }}
                    className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-12 h-12 flex items-center justify-center bg-white/10 hover:bg-white/20 text-white rounded-full transition-colors pointer-events-auto"
                  >
                    <ArrowLeft size={24} />
                  </button>
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); goToSlide(currentIndex + 1); }}
                    className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-12 h-12 flex items-center justify-center bg-white/10 hover:bg-white/20 text-white rounded-full transition-colors pointer-events-auto"
                  >
                    <ArrowRight size={24} />
                  </button>
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-white text-sm pointer-events-none">
