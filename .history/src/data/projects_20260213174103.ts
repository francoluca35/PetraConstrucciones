...
export const projects: Project[] = [
  ...
  
  {
    ...
    category: 'Diseño',
    description: 'Construccion de residencia unifamiliar con piscina y vista amplia.',
    location: 'Merida, Mexico',
    year: '2024',
    features: ['Moderna', 'Diseño bioclimático', 'Materiales ecológicos', 'Ahorro energético 40%'],
  },
 
  {
    slug: 'edificio-one-rose',
    label: 'RESIDENCIA ONE ROSE',
    image: '/Assets/Proyecto-5/1.png',
    gallery: [
