  ...
  return (
    <section className="relative flex min-h-screen flex-col justify-end overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-end px-6 pb-22 pt-20 md:px-12 md:pb-56 md:pt-24 lg:px-16 lg:pb-56 lg:pt-24">
        {/* Título principal - efecto máquina de escribir */}
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          className="mb-6 text-left font-bold uppercase leading-[1.1] text-white"
        >
          <span className="block text-4xl tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            <Typewriter text="PETRA" delay={400} speed={90} />
          </span>
          <span className="block text-4xl tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            <Typewriter text="CONSTRUCCIONES" delay={900} speed={70} />
          </span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0 }}
          ...
          className="mb-8 text-left text-lg font-medium tracking-wide text-white/90 sm:text-xl md:text-2xl"
        >
          <Typewriter text="Construyendo tus sueños" delay={2100} speed={55} />
        </motion.p>
