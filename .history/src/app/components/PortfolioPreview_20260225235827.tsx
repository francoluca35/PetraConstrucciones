...
const portfolioItems = [
  { slug: 'lote-43', title: 'Lote 43', categoryKey: 'portfolio.category.residential', image: '/Assets/Proyecto-3/1.png', descriptionKey: 'portfolio.desc.lote43', alt: 'Construcción de vivienda residencial en Mérida, Yucatán - Lote 43' },
  { slug: 'ResidenciaMerida', title: 'Residencia Mérida', categoryKey: 'portfolio.category.residential', image: '/Assets/Proyecto-1/1.png', descriptionKey: 'portfolio.desc.merida', alt: 'Casa moderna construida en Mérida, Yucatán - Residencia Mérida' },
  { slug: 'lote-101', title: 'Lote 101', categoryKey: 'portfolio.category.offices', image: '/Assets/Proyecto-2/1.png', descriptionKey: 'portfolio.desc.lote101', alt: 'Construcción de oficinas en Mérida, Yucatán - Lote 101' },
];
