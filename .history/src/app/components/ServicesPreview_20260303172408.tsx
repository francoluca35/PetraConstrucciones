  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-8 p-8 md:p-10 bg-white/5 backdrop-blur-md rounded-sm border border-[var(--petra-gld)]/20 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)]">
