        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 p-6 md:p-8 bg-neutral-900/50 backdrop-blur-sm rounded-2xl border border-neutral-800">
            ...
            <a
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-[var(--petra-gold)] hover:bg-[var(--petra-gold)] text-neutral-950 font-medium rounded-full transition-all duration-300 whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-neutral-950"
