    ...
    <section className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        >
          <Link
            href="/portfolio"
            className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--petra-navy)] text-white font-semibold rounded-lg hover:bg-[var(--petra-navy-dark)] transition-colors group"
          >
            Ver Más
