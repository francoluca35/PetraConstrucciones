      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            ...
            >
              <span
                className="text-2xl md:text-3xl lg:text-4xl font-bold uppercase text-[#283777] tracking-tight"
                style={{ fontFamily: "'Good Times', sans-serif" }}
              >
                Petra
              </span>
              <span
                className="inline-block text-[10px] md:text-xs uppercase font-bold text-[#E5C337] mt-1.5 tracking-[0.4em] origin-center"
                style={{ fontFamily: "'911', sans-serif", transform: 'scaleX(1) scaleY(0.85)' }}
              >
                Construcciones
              </span>
            </motion.div>
