      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            ...
            >
              <span
                className="text-2xl md:text-4xl lg:text-4xl font-bold uppercase text-[#283777] tracking-tight"
              ...
              <span
                ...
                style={{ fontFamily: "'911', sans-serif", transform: 'scaleX(.8) scaleY(3.5)' }}
              >
                Construcciones
              </span>
            </motion.div>
