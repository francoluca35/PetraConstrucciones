      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            ...
            >
              <span className="text-2xl md:text-3xl lg:text-4xl font-bold uppercase tracking-[0.2em] text-[#31418E]">
                Petra
              </span>
              <span className="text-xs md:text-xl uppercase font-bold tracking-[0.25em] text-[#F8D548] mt-0.5" style={{ fontFamily: "'911', sans-serif" }}>
                Construcciones
              </span>
            </motion.div>
          </Link>
