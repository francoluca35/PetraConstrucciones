      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            <motion.div whileHover={{ scale: 1.05 }} className="flex flex-col items-start leading-tight">
              {/* <Image src={logo} alt="PetraConstrucciones" width={120} height={48} className="h-12 w-auto" /> */}
              <span className="text-2xl md:text-3xl font-bold text-[#244281] tracking-[0.11em]" style={{ fontFamily: "'Good Times', sans-serif" }}>Petra</span>
              <span className="text-xl md:text-base text-[#244281] tracking-[0.11em]">Construcciones</span>
            </motion.div>
          </Link>
