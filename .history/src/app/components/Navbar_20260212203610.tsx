        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            ...
            >
              ...
              <span
                className="inline-block text-[1px] md:text-xs uppercase font-bold text-[#E5C337] mt-1.5 tracking-[.4em] origin-center"
                style={{ fontFamily: "'911', sans-serif", transform: 'scaleX(1.2) scaleY(3.1)' }}
              >
                Construcciones
              </span>
            </motion.div>
