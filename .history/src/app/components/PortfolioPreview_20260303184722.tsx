...
const portfolioItems = [
  ...
  { slug: 'piscinas', title: 'Piscinas', categoryKey: 'portfolio.category.pools', image: '/Assets/Proyecto-7/4.png', descriptionKey: 'portfolio.desc.piscinas', alt: 'Piscinas y espacios de bienestar en Mérida, Yucatán - Proyecto Piscinas' },
];
