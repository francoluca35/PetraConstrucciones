          ...
          <Link href="/" className="flex items-center">
            ...
            >
              <span
                ...
                style={{ fontFamily: "'Good Times', sans-serif", textShadow: '0 2px 4px rgba(0,0,0,6)' }}
              >
                Petra
              </span>
              <span
                className="inline-block text-[15px] md:text-xs uppercase font-bold text-[#E5C337] mt-1.1 tracking-[.4em] origin-center"
                style={{ fontFamily: "'911', sans-serif", transform: 'scaleX(1.1) scaleY(2.5)' }}
              >
                Construcciones
              </span>
            </motion.div>
