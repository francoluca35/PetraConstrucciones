          ...
          >
            ...
            <div className="relative flex items-center justify-center px-6 pt-12 pb-6">
              <Link href="/" onClick={() => setIsOpen(false)} className="flex flex-col items-center">
                <span
                  className="text-3xl font-bold uppercase tracking-wide text-[#283777]"
                  style={{ fontFamily: "'Good Times', sans-serif" }}
                >
                  Petra
                </span>
                <span
                  className="text-sm  uppercase whitespace-nowrap [transform:scaleX(0.92)_scaleY(2.5)] font-bold tracking-widest text-[#E5C337]"
                  style={{ fontFamily: "'911', sans-serif" }}
                >
                  Construcciones
                </span>
                ...
                >
                  <Link
                    ...
                    className={`text-4xl font-medium tracking-wide transition-colors ${
                      pathname === link.path ? 'text-[#283777]' : 'text-zinc-800 hover:text-[#E5C337]'
                    }`}
                  >
                    {link.name}
                  </Link>
