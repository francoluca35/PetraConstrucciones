...
const BG_IMAGES_MOBILE: { src: string; objectPosClass?: string }[] = [
  { src: '/Assets/Proyecto-1/casa-moderna-merida-yucatan-frente-1.avif', objectPosClass: 'object-center' },
    ...
    <section className="relative flex min-h-screen flex-col justify-end overflow-hidden">
      ...
      <div className="absolute inset-0 hidden lg:block">
        ...
        <div
          className="absolute inset-0 z-10"
          style={{
            background: 'linear-gradient(to bottom, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.4) 60%, rgba(0,0,0,0.2) 100%)',
          }}
        />
      </div>
