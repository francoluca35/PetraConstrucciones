      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center">
            ...
            >
              <span
                className="text-3xl md:text-4xl lg:text-5xl font-bold uppercase text-[#283777] tracking-[0.2em]"
                style={{ fontFamily: "'Good Times', sans-serif" }}
              >
                Petra
              </span>
              <span
                className="inline-block text-[15px] md:text-xs uppercase font-bold text-[#E5C337] mt-1.5 tracking-[0.1em] origin-center"
