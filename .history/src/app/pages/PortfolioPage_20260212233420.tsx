  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        ...
        >
          <span className="text-[var(--mavic-navy)]">PROYECTOS </span>
          <span className="text-[var(--mavic-gold)]">PETRA CONSTRUCCIONES</span>
        </motion.h2>
      </section>

      {/* Grilla 2 columnas: imagen + etiqueta abajo a la izquierda */}
