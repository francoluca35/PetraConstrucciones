      ...
      <section className="py-14 bg-white">
        <div className={sectionContainerClass}>
          ...
          >
            ...
            <a
              href="#servicios"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[var(--petra-navy)] text-white font-semibold rounded-xl hover:bg-[var(--petra-navy-dark)] transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
            >
      ...
      <section className="py-12 bg-[var(--petra-navy)] text-white">
        <div className={sectionContainerClass}>
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm mb-4">{profile.cedula}</p>
            <div className="flex flex-wrap justify-center gap-6">
              <a href={`tel:${profile.phone.replace(/\s/g, '')}`} className="inline-flex items-center gap-2 text-[var(--petra-gold)] hover:underline">
                <Phone size={18} />
                {profile.phone}
              </a>
              <a href={`mailto:${profile.email}`} className="inline-flex items-center gap-2 text-[var(--petra-gold)] hover:underline">
                <Mail size={18} />
                {profile.email}
              </a>
            </div>
