...
export const metadata: Metadata = {
  title: 'Conesa constructora estrategia SA - Excelencia en Construcción',
  description:
    'Conesa constructora estrategia SA - Líderes en construcción residencial, comercial e industrial. Más de 20 años transformando proyectos en realidad con excelencia e innovación.',
  keywords:
